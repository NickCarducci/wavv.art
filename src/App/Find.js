...
class Find extends React.Component {
  ...
  render() {
    ...
    hello = predictions && predictions.length > 0 ? predictions : hello;
    return (
      <div
        ref={this.props.fwd}
        onMouseEnter={() =>
          ...
          >
            ...
            >
              <img
                style={{ width: "100%" }}
                alt="school"
                src="https://www.dropbox.com/s/ftpf6yn3kdzaiqd/ezgif.com-gif-maker.gif?raw=1"
              />
              school
            </div>
            <div
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    ...
                    if (x.isCommunity) {
                      this.props.navigate(`/${x.message}`);
                      //this.props.chooseCommunity(x);
                    } else {
