...
import { CDB } from "./authdb"; //homes occupy home contractor bookkeeper chores. don't like advocates of system but prisoner-advocates
    ...
    return (
      <div className="login">
        ...
        <img
          ...
          src="https://www.dropbox.com/s/9ctrgn3angb8zz4/Screen%20Shot%202019-10-02%20at%2011.30.21%20AM.png?raw=1"
          alt="error"
        />
        <video
          ref={this.video}
        ...
        >
          <source
            src="https://www.dropbox.com/s/eqdqu6op7pa2wmg/My%20Movie%2015.mp4?raw=1"
            type="video/mp4"
          />
