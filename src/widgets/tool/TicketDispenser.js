        ...
        this.props.users
          ...
          <form
            onSubmit={(e) => {
              ...
              addDoc(collection(firestore, "tickets"), {
                eventId: event.id,
                ...
                this.props.users
                  ...
                  .map((b) =>
                    updateDoc(doc(firestore, "users", this.props.auth.uid), {
                      requestForgivenessFrom: this.props.user.requestForgivenessFrom.includes(
                        b.id
                      )
                        ? firebase.firestore.FieldValue.arrayRemove(b.id)
                        : firebase.firestore.FieldValue.arrayUnion(b.id)
                    })
                  );
              }}
            >
