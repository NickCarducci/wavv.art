...
class Edit extends React.Component {
  state = {};
  render() {
    const { drawerClasses, thisone, chosenEntity, coll } = this.props;
    return (
      <div
        ...
        >
          ...
          {thisone ? (
            !thisone.privateToMembers ? (
              <div
                onClick={() =>
                  updateDoc(doc(firestore, coll, chosenEntity.id), {
                    privateToCommunity: !chosenEntity.privateToCommunity
                  })
                }
                style={{
                  height: "60px",
              ...
              >
                {coll.toUpperCase()} in {thisone.message} are private to members
