...
export default PlanArcs;

/*<Link to={{ pathname: `/plans/${this.state.selectedplan}` }}>*/

//yeah but zombie videos, "ventilators, masks, passports"

//Who has said they're fake?

//authorities are waged usufruct

//ah maybe I should have cited a cow tow
