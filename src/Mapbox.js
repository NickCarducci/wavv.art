...
import "./App/SwitchCity/Display/Headerstyles.css";
                  ...
                  {mapit &&
                    mapit.map((x) => {
                      ...
                      if (canIView(auth, x, community)) {
                        ...
                        if (!x.venue && !x.subtype.includes(this.props.subtype))
                          return null;
                        if (x.id.length < 10) {
                          let names = [];
                          x.artistList.map((e) => {
                        ...
                        if (x.center || (x.venue && x.venue.longitude)) {
                          ...
                          return (
                            <Marker
                              ...
                              latitude={
                                x.venue ? x.venue.latitude : Number(x.center[0])
                              }
                              event={x}
